            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        ...
                        to="/educationSupports/educationCourses"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                title: '코딩 가이드', 
                description: '코딩 가이드 문서', 
                key: 'codingGuides', 
                route: '/codingGuides/codingGuides',
                ImageUrl: '',
            },
            { 
                title: '교육 과정', 
                description: '자율주행 프로젝트 교육 과정 정보', 
                key: 'educationCourses', 
                route: '/educationSupports/educationCourses',
                ImageUrl: '',
            },
